            ...
            <div className="lg:col-span-3 xl:col-span-4">
              <div>
                ...
                <p className="block text-sm text-gray-400 mb-9">
                  Smart Credit Financing AI — Privacy-preserving federated learning with transparent explainable AI for supply chain financing in Ethiopia and beyond.
                </p>
                <div className="flex">
                  <a
                    href="#!"
            ...
            <div className="lg:col-span-3">
              <div>
                ...
                <p className="block mb-5 text-sm text-gray-400">
                  Subscribe for updates on SCF AI products and insights.
                </p>
                <form>
