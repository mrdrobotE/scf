...
export const BILLING_PLANS = [
  {
    ...
    pricing: {
      monthly: {
        ...
        formattedPrice: 'ETB ' + AMOUNTS['free']['monthly'],
        stripeId: null,
      },
      yearly: {
        amount: AMOUNTS['free']['yearly'],
        formattedPrice: 'ETB ' + AMOUNTS['free']['yearly'],
        stripeId: null,
      },
    },
    features: [
